...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['manager_id'], ['employees.employee_id'], name='fk_employees_manager'),
        sa.ForeignKeyConstraint(['created_by'], ['employees.employee_id'], name='fk_employees_created_by'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['created_by'], ['employees.employee_id'], name='fk_work_codes_created_by'),
        sa.PrimaryKeyConstraint('work_code_id'),
    )
    op.create_index('ix_work_codes_code', 'work_codes', ['code'], unique=True)
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['employee_id'], ['employees.employee_id'], name='fk_time_entries_employee'),
        sa.ForeignKeyConstraint(['work_code_id'], ['work_codes.work_code_id'], name='fk_time_entries_work_code'),
        sa.ForeignKeyConstraint(['created_by'], ['employees.employee_id'], name='fk_time_entries_created_by'),
        sa.ForeignKeyConstraint(['modified_by'], ['employees.employee_id'], name='fk_time_entries_modified_by'),
        sa.ForeignKeyConstraint(['deleted_by'], ['employees.employee_id'], name='fk_time_entries_deleted_by'),
        sa.PrimaryKeyConstraint('entry_id'),
    )
    op.create_index('ix_time_entries_employee_id', 'time_entries', ['employee_id'])
    op.create_index('ix_time_entries_work_code_id', 'time_entries', ['work_code_id'])
    ...
    op.create_index('ix_time_entries_is_deleted', 'time_entries', ['is_deleted'])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['modified_by'], ['employees.employee_id'], name='fk_business_rules_modified_by'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['performed_by'], ['employees.employee_id'], name='fk_audit_log_performed_by'),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['employee_id'], ['employees.employee_id'], name='fk_user_sessions_employee'),
    ...
    op.create_index('ix_user_sessions_employee_active', 'user_sessions', ['employee_id', 'is_active'])
